...
public class ExpenseSearchUrlBuilder extends BaseUrlstringBuilder{
    ...
    ExpenseSearchUrlBuilder setApp(AppCompatActivity app){
        FApp = app;
        return this;
    }
    ExpenseSearchUrlBuilder InitUrl(Map<String, String> aParams){
        FParams = aParams;
        return this;
    }
    ...
    ExpenseSearchUrlBuilder setPageNum(int aPageNum){
        FPageNum = aPageNum;
        return this;
    }
    int getPageNum(){
    ...
    public String Build(){
        if(null == FUrlBuilder && null != FParams && null != FApp){
            ...
            okhttp3.HttpUrl okUrl = HttpUrl.parse(url);
            if(null != okUrl){
